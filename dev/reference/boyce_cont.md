...
appropriate for Species Distribution Models with presence only data
(i.e. using pseudoabsences or background). The algorithm used here comes
from the package `enmSdm`, and uses multiple overlapping windows.
...
presences. Ecol. Model., 199, 142-152.
