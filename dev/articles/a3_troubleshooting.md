...
#> ✔ 1 of 2 resampling: default_glm (606ms)
...
#> There were issues with some computations   A: x1There were issues with some computations   A: x15   B: x6
...
#> i  No tuning parameters. `fit_resamples()` will be attempted
#> i 1 of 2 resampling: default_glm
#> ✔ 1 of 2 resampling: default_glm (558ms)
#> i  No tuning parameters. `fit_resamples()` will be attempted
#> i 2 of 2 resampling: default_gam
#> ✔ 2 of 2 resampling: default_gam (919ms)
```
...
#> ✔ 1 of 3 resampling: default_glm (345ms)
#> i  No tuning parameters. `fit_resamples()` will be attempted
...
#> i Creating pre-processing data to finalize 1 unknown parameter: "mtry"
#> ✔ 3 of 3 tuning:     default_rf (943ms)
```
