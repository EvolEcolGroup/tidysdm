...
you should fix them directly in the files that describe the function. This is the
...
We reccomend that you study first how 
...
functional change in the code. We use `testthat`, you will find tests under
...
Make sure that, if possible, you use built-in datasets.
