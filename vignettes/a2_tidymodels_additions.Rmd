...
lacerta_models <-
  ...
  option_add(control = control_ensemble_bayes())
```
...
help page on how a Gaussian Process model is used to choose parameter
combinations).
...
lacerta_stack <-
  ...
  # the stacking penalty is selected to maximize the continuous Boyce index
  blend_predictions(
    metric = yardstick::metric_set(tidysdm::boyce_cont)
  ) %>%
