...
prediction_binary_repens_major <- predict_raster(lacerta_rep_ens,
  climate_present,
  type = "class",
  fun = "median",
  class_thresh = c("tss_max"),
...
ggplot() +
  geom_spatraster(data = prediction_binary_repens_major, aes(fill = binary_median.majority)) +
  geom_sf(data = lacerta_thin %>% filter(class == "presence")) +
  scale_fill_discrete(na.value = "transparent")
```
