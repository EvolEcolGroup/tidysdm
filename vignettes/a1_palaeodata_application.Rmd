...
`tidysdm` on time-scattered (i.e.palaeontological, archaeozoological, archaeological) data, with samples covering different time periods. We reccomend users first read the "tidysdm overview" article,
