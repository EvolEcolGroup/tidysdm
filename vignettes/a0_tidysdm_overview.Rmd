...
climate_future_clamped <- clamp_predictors(climate_future, 
                                           ...
                                           .col= class)
prediction_future_clamped <- predict_raster(lacerta_ensemble, climate_future_clamped)
...
# plot as a mask 
terra::plot(prediction_future, fun = function() polys(lacerta_mess_future_subset, col = "lightgray", alpha=0.5, lwd = 0.5))
```
