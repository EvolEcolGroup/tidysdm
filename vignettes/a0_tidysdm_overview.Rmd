...
This data is taken from: GBIF Occurrence Download (6 July 2023) <https://doi.org/10.15468/dl.srq3b3>. We can also easily access and manipulate this data using `rbgif`. We illustrate here how to do it:
