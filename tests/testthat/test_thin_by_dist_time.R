...
test_that("thin_by_dist_time removes the correct points", {
  ...
  set.seed(123)
  thin_100k <- thin_by_dist_time(locations, dist_min = 100000,
  ...
  set.seed(123)
  thin_100k_t <- thin_by_dist_time(locations, dist_min = 100000,
                                 interval_min = 365*2000,
                                 time_col="time_bp",
                                 lubridate_fun = ybp2date)
  ...
  thin_100k_t_sf <- thin_by_dist_time(locations_sf, dist_min = 100000,
                                   interval_min = 365*2000,
                                   time_col="time_bp",
                                   lubridate_fun = ybp2date)
