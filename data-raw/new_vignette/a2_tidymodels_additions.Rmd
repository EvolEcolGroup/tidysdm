...
be used to enhance SDMs. We reuse the example on the Iberian lizard that we used
...
and then thin the presences (using the same seeds that we used in the original vignette):
```{r thin}
set.seed(1234567)
...
lacerta_rec_uncor <- lacerta_rec_all %>% step_select(c("bio05","bio06", "bio13", "bio15"))
lacerta_rec_uncor
```
