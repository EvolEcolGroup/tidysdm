...
- **Margherita Colucci**. Author.

- **Andrea Vittorio Pozzi**. Author.

- **Eleanor M.L. Scerri**. Author.
...
Source:
[`DESCRIPTION`](https://github.com/EvolEcolGroup/tidysdm/blob/main/DESCRIPTION)

Leonardi M, Colucci M, Pozzi A, Scerri E, Manica A (2025). *tidysdm:
Species Distribution Models with Tidymodels*. R package version 1.0.4,
